...
### exercise_7-1 「캡스톤 : 하네스 총동원」 (40분)
- **필수 조건** : CLAUDE.md + Skill 1개 + SubAgent 1개 + Hook 1개 **모두 사용**
- **트랙 택1**

  | 트랙 | 주제 | 산출물 |
  | --- | --- | --- |
  | A | 커넥티드카 관제 콘솔 | 차량 실시간 목록·알람·상세 |
  | B | 스마트팩토리 설비 모니터링 | 설비 가동률·이상탐지·리포트 |
  | C | EV 충전 인프라 현황판 | 충전소 지도·혼잡도·예약 |

- **제출** : 동작 화면 + 자신이 만든 하네스 4종 설명 3분 발표
