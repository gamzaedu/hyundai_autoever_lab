...
> ⏱️ **제한 시간 10분** · 🎯 트랙 **택 1** · ✅ 합격 조건 = **발동 장면 재현**

---

## 🎯 미션

훅 스텁 하나를 골라 ⬜ 를 채우고, **실제로 발동하는 장면**을 만든다.

| 트랙 | 훅 | 이벤트 | 난이도 | 산출물 |
| --- | --- | --- | --- | --- |
| 🛡️ **A** | 위험 명령 차단 가드레일 | `PreToolUse` | ⭐⭐ | 차단 로그 |
| 📊 **B** | 작업 통계 리포트 | `SessionEnd` | ⭐⭐⭐ | `session_report.md` |
| 📓 **C** | Git 없이 쓰는 작업일지 | `Stop` | ⭐ | `worklog.md` |

> 💡 **처음이면 C**, 보안에 관심 있으면 **A**, transcript 파싱까지 해보고 싶으면 **B**.
